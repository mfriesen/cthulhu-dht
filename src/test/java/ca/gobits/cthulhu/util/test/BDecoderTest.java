...
public final class BDecoderTest {
    ...
    public void testDecode01() {
        ...
        // when
        Object result = new BDecoder().decode(s);

        // then
        assertTrue(result instanceof Map);
        Map<Object, Object> map = (Map<Object, Object>) result;
        assertEquals("announce_peer", map.get("q"));
        assertEquals("aa", map.get("t"));
        assertEquals("q", map.get("y"));
    }
    ...
    public void testDecode02() {
        ...
        assertEquals("aa", map.get("t"));
        assertEquals("q", map.get("y"));
        assertEquals("ping", map.get("q"));

        Map<Object, Object> map2 = (Map<Object, Object>) map.get("a");
        assertEquals("abcdefghij0123456789", map2.get("id"));
    }
    ...
    public void testDecode03() {
        ...
        Map<Object, Object> map2 = (Map<Object, Object>) map.get("a");
        assertEquals("abcdefghij0123456789", map2.get("id"));
        assertEquals("mnopqrstuvwxyz123456", map2.get("info_hash"));
        assertEquals(Long.valueOf(6881), map2.get("port"));
        assertEquals("aoeusnth", map2.get("token"));
    }
